...
const TicketBooking = () => {
    ...
    const handleSubmit = (e) => {
        ...
        navigate("/user/card-payment", { state: { ...eventDetails, tickets, total } });
    };
        ...
        >
            ...
            >
                ...
                <div
                    style={{
                        flex: 1.3,
                        backgroundImage: `url(${eventDetails.image || ticketImage})`,
                ...
                >
                    ...
                    <h3 className="text-center fw-semibold text-primary mb-2">
                        🎟️ Book Your Ticket
                    </h3>
                    ...
                    <p className="text-center mb-3">
                        <strong>💰 Rs.{eventDetails.price} per ticket</strong>
                    </p>
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Button
                            ...
                            onMouseOver={(e) =>
                                (e.target.style.background = "linear-gradient(90deg, #11998e 0%, #38ef7d 100%)")
                            }
                            onMouseOut={(e) =>
                                (e.target.style.background = "linear-gradient(90deg, #38ef7d 0%, #11998e 100%)")
                            }
                        >
